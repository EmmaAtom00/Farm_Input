        ...
        try {
            ...
            if (userData) {
                setProfile({
                    ...
                    primaryCrops: userData.primary_crops || [],
                });
            }
        } catch (error) {
        ...
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 80 }}>
                ...
                <View style={styles.header}>
                    ...
                    <Pressable onPress={() => router.push('/(main)/(profile)/EditProfile')}>
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <Text style={styles.value}>{profile.lga}</Text>
                    </View>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <Text style={styles.value}>{profile.village}</Text>
                    </View>
                </View>
                    ...
                    <View style={styles.cropsSection}>
                        ...
                        <View style={styles.cropsContainer}>
                            {profile.primaryCrops.map((crop, index) => (
                                <View key={index} style={styles.cropButton}>
