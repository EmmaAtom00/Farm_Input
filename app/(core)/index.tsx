  ...
  const cards = [
    {
      title: "Save Money",
      description:
        "Access bulk purchasing discounts and compare prices across suppliers to get the best deals on farm inputs.",
    },
    {
      title: "Track Spending",
      description:
        "Monitor your agricultural expenses with detailed analytics and insights to make informed decisions.",
    },
    {
      title: "Join Communities",
      description:
        "Connect with other farmers in buying groups to unlock better prices through collective purchasing power.",
    },
    {
      title: "Verified Suppliers",
      description:
        "Access a network of trusted and verified agricultural input suppliers with ratings and reviews.",
    },
    {
      title: "Mobile First",
      description:
        "Manage your farm inputs on-the-go with our intuitive mobile-optimized application.",
    },
    {
      title: "Data Insights",
      description:
        "Get detailed spending trends and analysis to optimize your agricultural budget and planning.",
    },
  ];
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        ...
        >
          ...
          >
            <Text style={{ fontSize: 36, color: "white", fontWeight: "700" }}>
              Ready to Shop?
            </Text>
